...
Configuration settings for the Yaounde Places Flask application.
...
class Config:
    ...
    SECRET_KEY = os.environ.get("SECRET_KEY", "yaounde-places-secret-key-change-in-production-2026")
